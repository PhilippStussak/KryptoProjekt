...
//                }else{
//                    //basesList.add(baseToAdd.add(Factory.newInstance(maxBase.get(0).getClass(), "2")));
...
//        return calculatePrime(maxBase, summands).subtract((E) Factory.newInstance(product.getClass(), "1"));
//     }
//
//
